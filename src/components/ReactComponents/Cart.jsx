    ...
    <div className="cart">
      ...
      <div className="total-cart-value">
        ...
        <div className="free-delivery-info">
          <svg-icon2 category="services" src="order" class="pr-8"><div _ngcontent-mdfrontw-c3850062867=""><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.78856 0.546908C7.92258 0.484364 8.07742 0.484364 8.21144 0.546908L14.2114 3.34691C14.3875 3.42906 14.5 3.60574 14.5 3.8V12.2C14.5 12.3943 14.3875 12.5709 14.2114 12.6531L8.21144 15.4531C8.07742 15.5156 7.92258 15.5156 7.78856 15.4531L1.78856 12.6531C1.61252 12.5709 1.5 12.3943 1.5 12.2V3.8C1.5 3.60574 1.61252 3.42906 1.78856 3.34691L7.78856 0.546908ZM2.5 4.80902V11.8816L7.5 14.2149V7.30902L2.5 4.80902ZM8.5 7.30902V14.2149L13.5 11.8816V4.80902L8.5 7.30902ZM13.0578 3.91208L8 1.55176L2.94219 3.91208L8 6.44098L13.0578 3.91208Z" fill="#292929"></path>
          </svg>
          </div></svg-icon2>
          <span class="text-l"> Free delivery on orders over $99.00. </span>
